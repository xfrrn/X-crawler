...
- 管理页采用与 AutoUp 一致的浅色中性工作台风格，按“总览、采集目标、内容库、登录与会话、运行状态”组织；微信公众号扫码登录集中在“登录与会话”页
...
- 面板的**平台目标**页负责添加、筛选、停止目标和按平台手动抓取；**平台内容**页按平台/目标浏览动态、图片和视频，并每 10 秒自动刷新。总览页汇总全部渠道目标、内容、异常和本机会话状态。
